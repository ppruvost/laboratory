 ...
 *
 * CORRECTIF : suppression de l'import mort "./produits.js"
 * (renommé en products.js dans la refonte de la base de données).
...
export const MASSES_MOLAIRES = {
  'C8H8O': 120.15,                  // acétophénone
  'C4H8O2': 88.11,                  // acide butanoïque
  'HCl': 36.46,
  'C10H16N2O8': 292.24,             // EDTA
  'CH3COOH': 60.05,
  'HNO3': 63.01,
  ...
  'Al': 26.98,
  'AlCl3': 133.34,
  'Al2(SO4)3·16H2O': 630.40,

  'NH4Cl': 53.49,
  '(NH4)2Fe(SO4)2·6H2O': 392.14,
  'NH4OH': 35.05,
  '(NH4)2C2O4': 124.10,
